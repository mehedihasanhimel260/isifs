...
@section('title', \App\CPU\translate('Referral Edit'))
@push('css_or_js')
...
<div class="content container-fluid">
    ...
    <div class="mb-3">
        <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
            ...
            {{\App\CPU\translate('Referral info_Update')}}
        </h2>
    </div>
    <!-- End Page Title -->
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">{{\App\CPU\translate('Referral info')}} {{\App\CPU\translate('Update')}} {{\App\CPU\translate('form')}}</h5>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.referral.management.update',$supplierinfo->id)}}" method="post" enctype="multipart/form-data" style="text-align: {{Session::get('direction') === " rtl" ? 'right' : 'left' }};">
                        @csrf
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" value="{{ $supplierinfo->phone }}" required name="phone" class="form-control" id="phone" placeholder="{{\App\CPU\translate('Ex')}} : +88017********">
                                </div>
                                <div class="col-md-6 form-group">
